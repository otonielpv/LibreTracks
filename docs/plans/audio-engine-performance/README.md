...
| Preparar warp/tono para directo | CPU evitada frente a tiempo de preparación, disco, RAM y respuesta a saltos/cambios | **[Construido, medido y RETIRADO](10-integracion-produccion.md).** 27 pistas con warp y tono miden 14 % del presupuesto en la app real: el multihilo ya resolvió el problema. No reconstruir sin un dato nuevo |
