...
| Preparar warp/tono para directo | CPU evitada frente a tiempo de preparación, disco, RAM y respuesta a saltos/cambios | [Prototipo medido y contrato de invalidación](06-audio-preparado.md); [fidelidad de arranques y saltos comprobada](07-fidelidad-saltos.md); [presupuesto de disco medido y formato decidido](08-presupuesto-y-formato.md); [controles del mezclador comprobados en vivo](09-controles-en-vivo.md); **[construido en producción de punta a punta: preparar, publicar y reproducir](10-integracion-produccion.md)**; pendiente interfaz, verificación en la aplicación real y dispositivo modesto |
