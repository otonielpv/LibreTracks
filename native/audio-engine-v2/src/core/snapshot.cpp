...
std::string snapshot_to_json(const EngineSnapshot& snap) {
    ...
    j["pitch"] = {
        ...
        {"realtime_pitch_underflow_count", snap.pitch.realtime_pitch_underflow_count},
        {"realtime_pitch_discontinuities", snap.pitch.realtime_pitch_discontinuities},
        {"realtime_seek_safe_preroll_frames", snap.pitch.realtime_seek_safe_preroll_frames},
        {"realtime_pitch_start_pad_frames", snap.pitch.realtime_pitch_start_pad_frames},
        {"realtime_pitch_start_delay_frames", snap.pitch.realtime_pitch_start_delay_frames},
        {"realtime_pitch_preroll_frames", snap.pitch.realtime_pitch_preroll_frames},
        {"realtime_pitch_discarded_frames", snap.pitch.realtime_pitch_discarded_frames},
        ...
        {"unsafe_cross_thread_reset_count", snap.pitch.unsafe_cross_thread_reset_count},
        {"concurrent_stream_mutation_detected", snap.pitch.concurrent_stream_mutation_detected},
        {"active_stream_swap_count", snap.pitch.active_stream_swap_count},
        {"long_seek_count", snap.pitch.long_seek_count},
        {"last_transport_discontinuity_target_frame", snap.pitch.last_transport_discontinuity_target_frame},
        {"last_transport_discontinuity_reason", snap.pitch.last_transport_discontinuity_reason},
