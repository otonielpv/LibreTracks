...
std::string snapshot_to_json(const EngineSnapshot& snap) {
    ...
    j["cpu"] = {
        ...
        {"warp_feed_gap_frames", snap.cpu.warp_feed_gap_frames},
        {"warp_feed_gap_events", snap.cpu.warp_feed_gap_events},
        {"warp_source_frames_fed", snap.cpu.warp_source_frames_fed},
        {"warp_output_frames_made", snap.cpu.warp_output_frames_made},
    ...
    j["pad"] = {
        {"enabled", snap.pad.enabled},
        {"clip_loaded", snap.pad.clip_loaded},
        {"key", snap.pad.key},
        {"clip_key", snap.pad.clip_key},
        {"pad_id", snap.pad.pad_id},
        {"route_resolved", snap.pad.route_resolved},
        {"muted_reason", snap.pad.muted_reason},
        {"current_gain", snap.pad.current_gain},
    };
