const es = {
  ...
  transport: {
    ...
    shell: {
      ...
      emptyDescription: "Inicia un proyecto nuevo o abre uno existente. Importa assets WAV despues desde el panel Libreria y arrastralos al timeline solo cuando quieras organizarlos.",
