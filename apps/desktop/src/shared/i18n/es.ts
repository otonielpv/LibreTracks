const es = {
  mobileClipActions: {
    title: "Acciones de la selección",
    selected: "{{count}} sel.",
    duplicate: "Duplicar",
    split: "Cortar en el cabezal",
    delete: "Eliminar",
  ...
  mobileEmptyLanes: {
    ...
    hint: "Añade los audios de la canción y aparecerán aquí como pistas.",
  ...
  transport: {
    ...
    renderModal: {
      eyebrow: "Renderizar",
      title: "Renderizar audio",
      untitled: "Canción",
      tracks: "Pistas",
      noTracks: "Esta canción no tiene pistas de audio con clips.",
      selectedCount: "{{count}} de {{total}} seleccionadas",
      selectAll: "Todas",
      selectNone: "Ninguna",
      output: "Salida",
      mixTitle: "Mezcla (un archivo)",
      mixDescription: "Todas las pistas marcadas sumadas en un solo WAV. Lo que le mandas al músico.",
      stemsTitle: "Pistas por separado (.zip)",
      stemsDescription: "Un WAV por pista, alineados desde el inicio de la canción, dentro de un .zip.",
      format: "Formato",
      formats: {
        pcm16: "WAV 16 bits",
        pcm24: "WAV 24 bits",
        float32: "WAV 32 bits (coma flotante)",
      },
      sampleRate: "Frecuencia de muestreo",
      sampleRateProject: "La del proyecto",
      channels: "Canales",
      stereo: "Estéreo",
      mono: "Mono",
      applyMixer: "Aplicar la mezcla",
      applyMixerHint: "Volumen y paneo de cada pista y carpeta, y el volumen de la canción, como suenan al reproducir. Desmarcado: todas al 0 dB y centradas.",
      normalize: "Normalizar",
      normalizeHint: "Sube o baja cada archivo para que su pico quede en -0,3 dB.",
      includeMetronome: "Incluir el metrónomo",
      includeVoiceGuide: "Incluir la voz guía",
      metronomeStem: "Metrónomo",
      voiceGuideStem: "Voz guía",
      fileName: "Nombre del archivo",
      stemsFileName: "{{name}} - pistas",
      onlyFileName: "{{name}} ({{track}})",
      withoutFileName: "{{name}} (sin {{tracks}})",
      andSeparator: " ni ",
      customMixFileName: "{{name}} (mezcla)",
      choosingDestination: "Elige dónde guardarlo…",
      rendering: "Renderizando… {{percent}}%",
      packing: "Empaquetando las pistas…",
      saved: "Guardado: {{file}}",
      missingFiles_one: "{{count}} archivo de audio no se pudo leer y sale en silencio.",
      missingFiles_other: "{{count}} archivos de audio no se pudieron leer y salen en silencio.",
      failed: "No se pudo renderizar: {{error}}",
      cancelled: "Renderizado cancelado.",
      cancel: "Cancelar",
      confirm: "Renderizar",
      stop: "Detener",
      again: "Renderizar otra",
      close: "Cerrar",
    },
    exportModal: {
      eyebrow: "Exportar",
    ...
    menu: {
      ...
      colorOf: "Color: {{name}}",
      colorOfTracks_one: "Color: {{count}} pista",
      colorOfTracks_other: "Color: {{count}} pistas",
      mixOfTracks_one: "Mezcla: {{count}} pista",
      mixOfTracks_other: "Mezcla: {{count}} pistas",
      mixAppliesTo_one: "Se aplica a la pista seleccionada",
      mixAppliesTo_other: "Se aplica a las {{count}} pistas seleccionadas",
      createTimeSignatureMarker: "Crear marca de compás",
      changeTimeSignature: "Cambiar compás",
    ...
    status: {
      ...
      clipsDeleted: "{{count}} clips borrados.",
      ...
      tracksMovedIntoFolder_one: "{{count}} pista movida a {{name}}.",
      tracksMovedIntoFolder_other: "{{count}} pistas movidas a {{name}}.",
      tracksRemovedFromFolder_one: "{{count}} pista fuera de su carpeta.",
      tracksRemovedFromFolder_other: "{{count}} pistas fuera de su carpeta.",
      folderNotCreated: "No se pudo crear la carpeta.",
    ...
    automation: {
      ...
      destinationMarkersOf: "Marcas · {{song}}",
      destinationMarkersNoSong: "Marcas fuera de canción",
