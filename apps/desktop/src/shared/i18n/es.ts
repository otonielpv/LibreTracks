const es = {
  ...
  transport: {
    ...
    menu: {
      ...
      volumeOfTracks_one: "Volumen: {{count}} pista",
      volumeOfTracks_other: "Volumen: {{count}} pistas",
      panOfTracks_one: "Paneo: {{count}} pista",
      panOfTracks_other: "Paneo: {{count}} pistas",
      routingOfTracks_one: "Salida: {{count}} pista",
      routingOfTracks_other: "Salida: {{count}} pistas",
      volumeStep: "{{sign}}{{db}} dB",
      volumeReset: "Igualar a 0 dB",
      panStep: "{{sign}} {{amount}}%",
      panCenter: "Centrar",
      panHardLeft: "Todo a la izquierda",
      panHardRight: "Todo a la derecha",
