const en = {
  ...
  mobileSelectionActions: {
    multiSelectClips: "Select several clips",
    multiSelectClipsHint: "Tap more clips",
    mix: "Mix",
  ...
  transport: {
    ...
    renderModal: {
      ...
      untitled: "Song",
      tracks: "Tracks",
      noTracks: "This song has no audio tracks with clips.",
      selectedCount: "{{count}} of {{total}} selected",
      selectAll: "All",
      selectNone: "None",
      output: "Output",
      mixTitle: "Mix (one file)",
      mixDescription: "Every checked track summed into a single WAV. What you send the musician.",
      stemsTitle: "Separate tracks (.zip)",
      stemsDescription: "One WAV per track, aligned from the start of the song, inside a .zip.",
      format: "Format",
      formats: {
        pcm16: "WAV 16-bit",
        pcm24: "WAV 24-bit",
        float32: "WAV 32-bit float",
      },
      sampleRate: "Sample rate",
      sampleRateProject: "Project rate",
      channels: "Channels",
      stereo: "Stereo",
      mono: "Mono",
      applyMixer: "Apply the mix",
      applyMixerHint: "Each track and folder's volume and pan, and the song volume, as heard in playback. Unchecked: every track at 0 dB, centred.",
      normalize: "Normalize",
      normalizeHint: "Raises or lowers each file so its peak sits at -0.3 dB.",
      includeMetronome: "Include the metronome",
      includeVoiceGuide: "Include the voice guide",
      metronomeStem: "Click",
      voiceGuideStem: "Voice guide",
      fileName: "File name",
      stemsFileName: "{{name}} - stems",
      onlyFileName: "{{name}} ({{track}})",
      withoutFileName: "{{name}} (no {{tracks}})",
      andSeparator: " or ",
      customMixFileName: "{{name}} (mix)",
      choosingDestination: "Choose where to save it…",
      rendering: "Rendering… {{percent}}%",
      packing: "Packing the tracks…",
      saved: "Saved: {{file}}",
      missingFiles_one: "{{count}} audio file could not be read and is silent.",
      missingFiles_other: "{{count}} audio files could not be read and are silent.",
      failed: "Could not render: {{error}}",
      cancelled: "Render cancelled.",
      cancel: "Cancel",
      confirm: "Render",
      stop: "Stop",
      again: "Render another",
      close: "Close",
    },
    exportModal: {
      eyebrow: "Export",
    ...
    menu: {
      ...
      colorOf: "Colour: {{name}}",
      colorOfTracks_one: "Colour: {{count}} track",
      colorOfTracks_other: "Colour: {{count}} tracks",
      mixOfTracks_one: "Mix: {{count}} track",
      mixOfTracks_other: "Mix: {{count}} tracks",
      mixAppliesTo_one: "Applies to the selected track",
      mixAppliesTo_other: "Applies to the {{count}} selected tracks",
      createTimeSignatureMarker: "Create time-signature marker",
      changeTimeSignature: "Change time signature",
    ...
    status: {
      ...
      clipsDeleted: "{{count}} clips deleted.",
      ...
      tracksMovedIntoFolder_one: "Moved {{count}} track into {{name}}.",
      tracksMovedIntoFolder_other: "Moved {{count}} tracks into {{name}}.",
      tracksRemovedFromFolder_one: "Moved {{count}} track out of its folder.",
      tracksRemovedFromFolder_other: "Moved {{count}} tracks out of their folder.",
      folderNotCreated: "The folder could not be created.",
    ...
    automation: {
      ...
      destinationMarkersOf: "Markers · {{song}}",
      destinationMarkersNoSong: "Markers outside any song",
