const en = {
  ...
  timelineToolbar: {
    ...
    regionWarpTargetBpmAria: "New timeline BPM for the selected region",
    regionWarpTargetBpmLabel: "New BPM",
    regionWarpTargetBpmDownAria: "Decrease new timeline BPM by 1",
    regionWarpTargetBpmUpAria: "Increase new timeline BPM by 1",
