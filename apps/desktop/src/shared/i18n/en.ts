const en = {
  ...
  transport: {
    ...
    menu: {
      ...
      volumeOfTracks_one: "Volume: {{count}} track",
      volumeOfTracks_other: "Volume: {{count}} tracks",
      panOfTracks_one: "Pan: {{count}} track",
      panOfTracks_other: "Pan: {{count}} tracks",
      routingOfTracks_one: "Output: {{count}} track",
      routingOfTracks_other: "Output: {{count}} tracks",
      volumeStep: "{{sign}}{{db}} dB",
      volumeReset: "Match at 0 dB",
      panStep: "{{sign}} {{amount}}%",
      panCenter: "Centre",
      panHardLeft: "Hard left",
      panHardRight: "Hard right",
