...
describe("colocación de la tarjeta de la guía", () => {
  ...
  it("se centra cuando el objetivo no deja hueco en ningún lado", () => {
    ...
    const position = placeTourCard(
      { top: 30, left: 60, width: 1800, height: 840 },
      CARD,
      VIEWPORT,
    );
  ...
  it("una ventana diminuta acaba en tarjeta centrada, no en una franja", () => {
    const position = placeTourCard(
