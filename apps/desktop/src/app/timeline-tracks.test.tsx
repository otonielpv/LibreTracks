...
describe("App / timeline-tracks", () => {
  ...
  it("keeps multi-track selection on right click and offers what makes sense for several", async () => {
    ...
    //
    // La mezcla NO esta aqui: volumen, paneo y salida de varias pistas se
    // tocan con los faders de siempre, en el panel que abre la barra de la
    // seleccion (ver MobileSelectionActionBar). Un menu de escalones fijos era
    // un sucedaneo de un fader.
