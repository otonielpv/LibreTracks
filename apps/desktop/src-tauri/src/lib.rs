...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::settings::set_voice_guide_volume_realtime,
            ...
            commands::pads::set_pad_volume_realtime,
            commands::prepared::prepare_song_tracks,
            commands::prepared::cancel_song_preparation,
            commands::prepared::song_preparation_status,
