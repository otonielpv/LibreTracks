ALTER TABLE telemetry_product_events
  RENAME TO telemetry_product_events_before_live_view;
...
CREATE TABLE telemetry_product_events (
  ...
  event_name TEXT NOT NULL CHECK (event_name IN (
    ...
    'feature_compact_view', 'feature_live_view', 'feature_metronome',
    'feature_voice_guide', 'feature_ambient_pads', 'feature_automation',
    'feature_warp', 'feature_midi', 'feature_remote_panel', 'active_5m',
    'active_15m', 'active_30m', 'active_60m'
  )),
...
SELECT
  ...
  device_class,
  country_code
FROM telemetry_product_events_before_live_view;

DROP TABLE telemetry_product_events_before_live_view;
